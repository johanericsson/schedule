========================================================================
    STATIC LIBRARY : staticgrid Project Overview
========================================================================

AppWizard has created this staticgrid library project for you.

This file contains a summary of what you will find in each of the files that
make up your staticgrid application.
...
StdAfx.h, StdAfx.cpp
    ...
    named staticgrid.pch and a precompiled types file named StdAfx.obj.
...
project, including "resource.h", "staticgrid.rc" and a "staticgrid.h" that
